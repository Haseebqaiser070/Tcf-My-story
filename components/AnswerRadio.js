    ...
    <View style={styles.container}>
      <View style={styles.view}>
        <View style={styles.label}>
          ...
          <RadioButton
            selected={selectedView === "A"}
            onPress={() => handleSelectView("A")}
          />
        </View>
      </View>
      <View style={styles.view}>
        <View style={styles.label}>
          ...
          <RadioButton
            selected={selectedView === "B"}
            onPress={() => handleSelectView("B")}
          />
        </View>
      </View>
      <View style={styles.view}>
        <View style={styles.label}>
          ...
          <RadioButton
            selected={selectedView === "C"}
            onPress={() => handleSelectView("C")}
          />
        </View>
      </View>
      <View style={styles.view}>
        <View style={styles.label}>
          ...
          <RadioButton
            selected={selectedView === "D"}
            onPress={() => handleSelectView("D")}
          />
        </View>
      </View>
    </View>
