    ...
    {selected && (
      <View
        style={[
          ...
          isCorrect
            ? styles.radioButtonInnerCorrect
            : styles.radioButtonInnerError,
        ]}
      >
        <Image
          source={
            isCorrect ? require("../img/tick.png") : require("../img/cross.png")
          }
          style={isCorrect ? styles.tickIcon : styles.crossIcon}
        />
      </View>
    )}
  </View>
...
const AnswerSheet = () => {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      Navigator.goBack(); // Navigate to the result screen when on the last question
    }
  };
